             ...
             <div style="padding-top: 9%;">
                 <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                     ...
                     <tr>
                         <td>
                             <center>
                                 <h2 style="font-size: 4rem;font-weight: 600;color: #ec7fdf;margin-bottom: 25px;">Hello!</h2>
                             </center>
                         </td>
                     </tr>
                     <tr>
                                     ...
                                     <td>
                                         <div>
                                             <p class="update-pera-one"
                                                 style="margin: 0;font-size:20px;letter-spacing: normal;color: #404040;line-height:28px;">
                                                 You have requested for OTP through our One Time Password Verification
                                                 service.
                                             </p>
                                         </div>
                                     </td>
                                 ...
                                 <tr>
                                     <td>
                                         <div>
                                             <p class="update-pera"
                                                 style="margin: 0;font-size:20px;letter-spacing: normal;color: #404040;line-height:28px;">
                                                 Here is your OTP for Spiritualism Live registartion.
                                             </p>
                                         </div>
                                     </td>
                                 </tr>
                                 ...
                                 <tr>
                                     <td>
                                         <div style="margin: 50px 0;">
                                             <center>
                                                 <h2
                                                     style="font-size: 2rem;font-weight: 600;color: #ec7fdf;margin-bottom: 25px;">
                                                     `+ otp + `</h2>
                                             </center>
                                         </div>
                                     </td>
                                 ...
                                 <tr>
                                     <td>
                                         <div>
                                             <p class="update-pera"
                                                 style="margin: 0;font-size:20px;letter-spacing: normal;color: #404040;line-height:28px;">
                                                 If you face any issue with our solution, go to contact support chat.
