...
async function sendEmail(id, milliseconds, randomString, type) {
	var html =
		`
    <html>
        <body>
            <!-- <section class="update-status" style="height: 100vh;text-align: center;background-image:url(cid:emailImage);width: 100%;background-size: cover;">
             <div class="update-panel" style="height: 100%; background-image: url(cid:emailImage)">
                ...
                <p class="update-pera-one" style="margin: 0;font-size:20px;letter-spacing: normal;color: #404040;line-height:28px;">You have requested to reset your app password through our forgotten password
                 ...
                 <p class="regard-pera" style="margin-top: 50px; font-size:20px;letter-spacing: normal;color: #404040;line-height:28px;">Regards, MindScape Team
                                        ...
                                        <td>
                                            <div>
                                                <p
                                                    ...
                                                    "
                                                >
                                                    You have requested to reset your app password through our
                                                    forgotten password recovery service.
                                                    <span
                                                        style="
                                                            display: block;
                                                            text-align: center;
                                                            ...
                                                            font-weight: 500;
                                                        "
                                                        >Click the button below and change your password!</span
                                                    >
                                                </p>
                                            </div>
                                        </td>
